...
Named bodies orbit Sol: Hermes, Ares, Boreas, Thalassa, Kronos, Ouranos, and the distant elliptical dwarf **Nyx**, plus moons. The dense asteroid belt sits outside Thalassa (~2000 from Sol). Hold `M` for a live system map with your ship, stations, contacts, and Nyx’s stretched orbit.

Three orbital outposts share the same economy and outfitters:
...
1. **Mine** — blast asteroids for rock ore, volatile ice, and rare alloys. Drops magnet toward your hull when you get close. Occasional speed and fire-rate buff pickups spawn too.
...
4. **Save** — credits, cargo, hull, heat, armor, thruster, sensors, torpedoes, buffs, and dock state autosave to `localStorage`.
